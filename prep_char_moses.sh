data_dir=$1
mkdir -p $data_dir
#python3 preprocess.py raw_data $data_dir --src-prefixes 對齊外語語句 對齊外語字詞 dict_man \
#  --tgt-prefixes 對齊母語語句 對齊母語字詞 dict_tsm --dont-merge --char-level
python3 preprocess.py raw_data $data_dir/all --src-prefixes 對齊外語語句 對齊外語字詞 \
  --tgt-prefixes 對齊母語語句 對齊母語字詞 --dont-merge --char-level
